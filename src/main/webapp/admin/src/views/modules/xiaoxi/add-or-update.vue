    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="消息标题" prop="xiaoxiName">
                       <el-input v-model="ruleForm.xiaoxiName"
                                 placeholder="消息标题" clearable  :readonly="ro.xiaoxiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="消息标题" prop="xiaoxiName">
                           <el-input v-model="ruleForm.xiaoxiName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="消息详情" prop="xiaoxiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xiaoxiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiaoxiContent" label="消息详情" prop="xiaoxiContent">
                            <span v-html="ruleForm.xiaoxiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xiaoxiContent: [
                              { required: true, message: '消息详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
