        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xiangmuFile" label="项目相关文件" prop="xiangmuFile">
                        <file-upload
                                tip="点击上传项目相关文件"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiangmuFile" label="项目相关文件" prop="xiangmuFile">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="项目状态" prop="xiangmuZhuangtaiTypes">
                        <el-select v-model="ruleForm.xiangmuZhuangtaiTypes" :disabled="ro.xiangmuZhuangtaiTypes" placeholder="请选择项目状态">
                            <el-option
                                v-for="(item,index) in xiangmuZhuangtaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    ...
                    xiangmuFile: '',
                    xiangmuContent: '',
                    xiangmuZhuangtaiTypes: '',
                    xiangmuDelete: '',
                    insertTime: '',
                },
                xiangmuTypesOptions : [],
                xiangmuZhuangtaiTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   xiangmuFile: [
                              { required: true, message: '项目相关文件不能为空', trigger: 'blur' },
                          ],
                   xiangmuContent: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xiangmu_zhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xiangmuZhuangtaiTypesOptions = data.data.list;
                    }
                });
